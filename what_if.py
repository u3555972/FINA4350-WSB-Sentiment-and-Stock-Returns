...
if start_date == '':
    ...
    print('No input, default 2019-01-01')

end_date = input('end(YYYY-MM-DD):')
if end_date == '':
    end_date = '2019-12-31'
    print('No input, default 2019-12-31')
...
plt.savefig(os.path.join(mypath, WSB_trading_expt))
...
def freq_barchart(word_count_df, path=mypath): #make a frequency chart
    ...
    plt.savefig(os.path.join(path, fullname), dpi=300)
    return chart

frequency_df = core_data_df
